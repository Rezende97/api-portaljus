            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Reclamante </h3>
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                            <li class="breadcrumb-item">Listagem</li>
                            <li class="breadcrumb-item active" aria-current="page">Reclamante</li>
                          </ol>
                        </nav>
                    </div>
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb"style="margin-left: 10px" >
                          <ol class="breadcrumb" >
                            <button class="btn btn-primary" >+ &nbsp Cadastrar Reclamante</button>
                          </ol>
                        </nav>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <h4 class="card-title">Reclamante</h4>
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td style="display: flex; justify-content: space-evenly; align-items: center">
                                            <i class='mdi mdi-border-color mdi-24px' style="cursor: pointer;" >
                                            <i class='mdi mdi-close-outline mdi-24px' style="cursor: pointer" >
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
